   ...
   const formik: any = useFormik({
      ...
      onSubmit: async (values, { resetForm }) => {
         try {
            ...
            const { statusText, status, data } = await axios.post('https://allianceaeapi.alliancerecruitmentagency.ae/contactUsNewForm', requestdata);
                        ...
                        <div className="item">
                           <div className="item-content">
                              <div className="icon-box">
                                 <Image src="/assets/images/landing-page/quote-up.svg" alt="Quote" width={24} height={24} />
                              </div>
                              ...
                              <div className="client-details">
                                 <span className="image-box">
                                    <Image src="/assets/images/landing-page/gary-morris.svg" alt="gary morris" width={40} height={40} />
                                 </span>
                                 <span className="client-name">Gary Morris</span>
                                 <span className="client-review"
                                 ><Image src="/assets/images/landing-page/star.svg" alt="star" width={16} height={16} /> 4.5</span
                                 >
                              </div>
                           </div>
                        </div>
                        <div className="item">
                           <div className="item-content">
                              ...
                              <div className="client-details">
                                 ...
                                 <span className="client-review"
                                 ><Image src="/assets/images/landing-page/star.svg" alt="star" width={16} height={16} /> 4.3</span
                                 >
                              </div>
                           </div>
                        </div>
                        <div className="item">
                           <div className="item-content">
                              ...
                              <div className="client-details">
                                 ...
                                 <span className="client-review"
                                 ><Image src="/assets/images/landing-page/star.svg" alt="star" width={16} height={16} /><span
                                    className="data"
                                 >
                                       4.4</span
                                    ></span
                        ...
                        <div className="item">
                           <div className="item-content">
                              ...
                              <div className="client-details">
                                 ...
                                 <span className="client-name">Martin Albinson</span>
                                 <span className="client-review">
                                    <Image src="/assets/images/landing-page/star.svg" alt="star" width={16} height={16} />
                        ...
                        <div className="contact-form-wrapper" >
                           <div className="contact-fom-content">
                              <div className="left-image-box">
                                 <Image src="/assets/images/landing-page/contact-form.png" alt="contact form" width={500} height={600} />
                              </div>
                           </div>
