...
interface ServiceTemplate4Props {
  data: any;
}

const ServiceTemplate4: React.FC<ServiceTemplate4Props> = ({ data }) => {
  ...
  return (
    <>
                ...
                <div className="col-lg-5  text-start">
                  <div className="story-img-c-level">
                    {(data.section6[0].image ||
                      !isYouTubeUrl(data.section6[0].imageLink)) && (
                        <DisabledLink
                          prefetch={false}
                          ariaLabel="position"
                          href={data.section6[0].imageLink}
                        >
                          <Image
                            loading="eager"
                            src={`${BE_URL}${data.section6[0].image}`}
                    ...
                    {isYouTubeUrl(data.section6[0].imageLink) && (
                      ...
                      >
                        <Image
                          ...
                          height={100}
                          alt="icon-youtube"
                          src="/assets/images/homepage/yt-icon.png"
                          loading="eager"
                        />
                      </Link>
                    )}
          ...
          <div className="container-fluid c-pad-x">
            <div className="inner-con bg-no no-box-shadow p-0">
              <div className="row gy-4">
                ...
                <div className="col-lg-5 align-self-start ms-auto text-end d-none_image">
                  <div className="story-img-c-level">
                    {(data.section7[0].image ||
                      !isYouTubeUrl(data.section7[0].imageLink)) && (
                        <DisabledLink
                          href={data.section7[0].imageLink}
                        >
                          <Image
                            loading="eager"
                            src={`${BE_URL}${data.section7[0].image}`}
      ...
      {/* SECTION 8 */}
      {data.section8 && data.section8[0].title && (
        <section className="accounting-section pb-0">
          <div className="container-fluid c-pad-x ">
            <div className="row gy-4 justify-content-evenly">
              <div className="col-lg-5 c-order-992-2 d-none_image">
                <div className="story-img-c-level">
                  {(data.section8[0].image ||
                    !isYouTubeUrl(data.section8[0].imageLink)) && (
                      <DisabledLink
                        href={data.section8[0].imageLink}
                      >
                        <Image
                          loading="eager"
                          src={`${BE_URL}${data.section8[0].image}`}
                          alt={data.section8[0].imageAlt}
              ...
              <div className="col-lg-6 c-order-992-1">
                <h2
                  className="com-title text-align-left text-align-left"
                  dangerouslySetInnerHTML={{ __html: data.section8[0].title }}
                ></h2>
                <p
                  className="com-text"
                  dangerouslySetInnerHTML={{
                    __html: data.section8[0].description.text,
                  }}
                ></p>
              </div>
            </div>
      ...
      {data.section9 && data.section9[0].title && (
        <section className="industry-section c-pad-y bg-light-blue">
          <div className="container-fluid c-pad-x">
            <div className="inner-con bg-no no-box-shadow p-0">
              <div className="row gy-4">
                <div className="col-lg-6">
                  <h2
                    className="com-title text-align-left"
                    dangerouslySetInnerHTML={{ __html: data.section9[0].title }}
                  />
                  <p
                    className="com-text color-gray"
                    dangerouslySetInnerHTML={{
                      __html: data.section9[0].description.text,
                    }}
                  />
                </div>
                <div className="col-lg-5 align-self-start ms-auto text-end d-none_image">
                  <div className="story-img-c-level">
                    {(data.section9[0].image ||
                      !isYouTubeUrl(data.section9[0].imageLink)) && (
                        <DisabledLink
                          prefetch={false}
                          href={data.section9[0].imageLink}
                        >
                          {data.section9[0].image && (
                            <Image
                              loading="eager"
                              src={`${BE_URL}${data.section9[0].image}`}
                              alt={data.section9[0].imageAlt}
      ...
      {data.section10 && (
        <section className="accounting-section pb-0">
          <div className="container-fluid c-pad-x ">
            <div className="row gy-4 justify-content-evenly">
              <div className="col-lg-6 c-order-992-2 d-none_image">
                {data.section10[0].image && (
                  <Image
                    loading="eager"
                    src={
                      data.section10[0].image
                        ? `${BE_URL}${data.section10[0].image}`
                        : ""
                    }
                    alt={data.section10[0].imageAlt}
              ...
              <div className="col-lg-6 c-order-992-1">
                <h2
                  className="com-title text-align-left text-align-left"
                  dangerouslySetInnerHTML={{ __html: data.section10[0].title }}
                ></h2>
                <p
                  className="com-text"
                  dangerouslySetInnerHTML={{
                    __html: data.section10[0].description.text,
                  }}
                ></p>
              </div>
            </div>
