...
import { isYouTubeUrl } from "@/utils/checkUrl";
...
interface ServiceTemplate3Props {
  data: any;
}

const ServiceTemplate3: React.FC<ServiceTemplate3Props> = ({ data }) => {
    ...
    <>
      ...
      {data.section7 && (
        <section className="industry-section c-pad-y bg-light-blue">
          <div className="container-fluid c-pad-x">
            <div className="inner-con bg-no no-box-shadow p-0 service-section-3">
              <div className="row gy-4">
                <div className="col-lg-6">
                  <h2
                    className="com-title text-align-left"
                ...
                <div className="story-img-c-level">
                  {(data.section8[0].image ||
                    !isYouTubeUrl(data.section8[0].imageLink)) && (
                      <DisabledLink href={data.section8[0].imageLink}>
                        {data.section8[0].image && (
                          <Image
                            loading="eager"
                            src={
                              data.section8[0].image
                                ? `${BE_URL}${data.section8[0].image}`
                                : ""
                            }
                  ...
                  <div className="story-img-c-level">
                    {(data.section9[0].image ||
                      !isYouTubeUrl(data.section9[0].imageLink)) && (
                        <DisabledLink href={data.section9[0].imageLink || ""}>
                          {data.section9[0].image && (
                            <Image
                              loading="eager"
                              src={
                                data.section9[0].image
                                  ? `${BE_URL}${data.section9[0].image}`
                                  : ""
                              }
